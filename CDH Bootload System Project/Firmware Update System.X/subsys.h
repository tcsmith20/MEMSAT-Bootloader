...
#define SUBSYS_IO_NONE 0
#define SUBSYS_IO_UART 1
#define SUBSYS_IO_PRINTF 2
#define SUBSYS_IO_CUSTOM 255 // if the user sets this, they are responsible for creating the macro hooks to the IO layer in their system.h file
...
#ifndef SUBSYS_IO
#ifdef SUBSYS_UART
#define SUBSYS_IO SUBSYS_IO_UART
#else
#define SUBSYS_IO SUBSYS_IO_NONE
#endif
#endif

#if SUBSYS_IO != SUBSYS_IO_NONE
#ifndef USE_MODULE_SUBSYS
#warning "USE_MODULE_SUBSYS not defined in system.h. Other modules won't be able to utilize this module."
#endif
#endif
...
/////////////////////////MMmmbbbb
#define SYSTEM_VERSION 0x03010003u ///< subsystem module version number
...
void SetLevel(uint8_t sys_id, enum log_level level);
