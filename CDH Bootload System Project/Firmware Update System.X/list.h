 ...
 *
 * @todo Jacob H move (or duplicate) some of the above documentation to the  members below and resend to MM
 */
 ...
 * @param identify_fn is a function pointer for identifying a function
 *
 */
