...
#define Set_U2Tx_PPS(pin) SetPPS_Out(pin) = 5 // U2TX
#define Set_U3Tx_PPS(pin) SetPPS_Out(pin) = 28 // U3TX
#define Set_U4Tx_PPS(pin) SetPPS_Out(pin) = 30 // U4TX

#define Set_U1Rx_PPS(pin) RPINR18bits.U1RXR = pin
#define Set_U2Rx_PPS(pin) RPINR19bits.U2RXR = pin
#define Set_U3Rx_PPS(pin) RPINR17bits.U3RXR = pin
#define Set_U4Rx_PPS(pin) RPINR27bits.U4RXR = pin
