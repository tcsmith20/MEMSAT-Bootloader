...
// expand the 16 byte key to 176 byte
...
//	copy passkey
	...
	state[248] = passkey[ 8];
	state[249] = passkey[ 9];
	state[250] = passkey[10];
	state[251] = passkey[11];
	state[252] = passkey[12];
	state[253] = passkey[13];
	state[254] = passkey[14];
	state[255] = passkey[15];
...
//	Encrypt
    ...
    aes_encr(state+16,  expandedKey);
    aes_encr(state+32,  expandedKey);
    aes_encr(state+48,  expandedKey);
    aes_encr(state+64,  expandedKey);
    aes_encr(state+80,  expandedKey);
    aes_encr(state+96,  expandedKey);
    aes_encr(state+112, expandedKey);
    aes_encr(state+128, expandedKey);
    aes_encr(state+144, expandedKey);
    aes_encr(state+160, expandedKey);
    aes_encr(state+176, expandedKey);
    aes_encr(state+192, expandedKey);
    aes_encr(state+208, expandedKey);
    aes_encr(state+224, expandedKey);
    aes_encr(state+240, expandedKey);
}
...
//	Decrypt
    ...
    aes_decr(state+16,  expandedKey);
    aes_decr(state+32,  expandedKey);
    aes_decr(state+48,  expandedKey);
    aes_decr(state+64,  expandedKey);
    aes_decr(state+80,  expandedKey);
    aes_decr(state+96,  expandedKey);
    aes_decr(state+112, expandedKey);
    aes_decr(state+128, expandedKey);
    aes_decr(state+144, expandedKey);
    aes_decr(state+160, expandedKey);
    aes_decr(state+176, expandedKey);
    aes_decr(state+192, expandedKey);
    aes_decr(state+208, expandedKey);
    aes_decr(state+224, expandedKey);
    aes_decr(state+240, expandedKey);
    
    unsigned short ii;
	unsigned short jj = 0;
    
    for(ii = 0; ii <= 15; ii++){
    	if(state[ii + 240] == passkey[ii])
    		jj++;
    	}
